...
class ClusterArgs:
    def __init__(__self__, *,
                 addons: Optional[pulumi.Input['ClusterAddonsArgsArgs']] = None,
        ...
        :param pulumi.Input['ClusterAddonsArgsArgs'] addons: The addons installed in the cluster.
    ...
    @property
    @pulumi.getter
    def addons(self) -> Optional[pulumi.Input['ClusterAddonsArgsArgs']]:
        """
    ...
    @addons.setter
    def addons(self, value: Optional[pulumi.Input['ClusterAddonsArgsArgs']]):
...
class Cluster(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 addons: Optional[pulumi.Input[pulumi.InputType['ClusterAddonsArgsArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClusterAddonsArgsArgs']] addons: The addons installed in the cluster.
    ...
    def cluster_addons(self) -> pulumi.Output[Any]:
        """
